...
llvm::StructType* get_or_create_struct(llvm::LLVMContext& Ctx,
                                       llvm::StringRef Name) {
    using namespace llvm;
...
AirType::AirType(LLVMContext& context) : context(context) {
    ...
    _texture2d_array =
        get_or_create_struct(context, "struct._depth_2d_array_t");
    ...
    _mesh_grid_properties =
        get_or_create_struct(context, "struct._mesh_grid_properties_t");
